...
Open Serial Monitor at 115200 baud to see real-time commands.
Connect a BLE-enabled mobile app to ESP32-Rover.
Send commands (F, B, L, R, S) to control the rover.
